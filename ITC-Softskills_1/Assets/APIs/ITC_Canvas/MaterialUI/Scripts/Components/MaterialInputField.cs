...
namespace MaterialUI
{
    ...
    public class MaterialInputField : UIBehaviour, ILayoutGroup, ILayoutElement, ISelectHandler, IDeselectHandler
    {
        ...
        private float GetTextHeight()
        {
            ...
            return textGenerator.GetPreferredHeight(layoutText, textGenerationSettings);
        }
        ...
        private float GetSmallHintTextHeight()
        {
            ...
            return textGenerator.GetPreferredHeight(hintTextObject.text, textGenerationSettings);
        }
        ...
        /// </summary>
		public void AnimateHintTextSelect()
        {
