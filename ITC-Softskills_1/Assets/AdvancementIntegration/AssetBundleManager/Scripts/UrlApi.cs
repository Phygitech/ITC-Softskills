...
public class UrlApi : MonoBehaviour
{
	...
	string BaseJsonPath = "http://test.com/learn/public/api/language-asset?topic_code=";
	string BaseLanguagePath = "&language_name=";
	...
	internal string GetAPIURl() {
		return ( BaseJsonPath + AssetBundleManager.Instance.GetTopicID() + BaseLanguagePath +  PlayerPrefs.GetString("currentLanguage") );
	}
}
