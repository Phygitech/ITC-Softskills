...
public class PlayPauseSimulation : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        jc = new AndroidJavaClass("broadcastplugin.test.com.masterappbroadcast.DPlay");
        jc.CallStatic("createInstance", this.name); 

        jc = new AndroidJavaClass("broadcastplugin.test.com.masterappbroadcast.DPause");
        jc.CallStatic("createInstance", this.name); 

        jc = new AndroidJavaClass("broadcastplugin.test.com.masterappbroadcast.DStop");
        jc.CallStatic("createInstance", this.name);
    ...
    public void ShowStartErrorMessage(string messageToBeShown)
    {
        ...
        startMessageCanvas.transform.localPosition = new Vector3(0f, 0f, ((1 / Camera.main.transform.parent.localScale.z) * 0.6f));
    ...
    public void SetTimeScale(float scale)
    {
        ...
        else if (scale == 0)
        {
            ...
            playPauseSimulationCanvas.transform.localPosition = new Vector3(0f, 0f, ((1 / Camera.main.transform.parent.localScale.z) * 0.6f));
